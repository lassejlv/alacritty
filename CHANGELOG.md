...
- Native split panes, with mouse-draggable dividers
- `SplitRight` / `SplitDown` / `ClosePane` / `FocusPaneLeft` / `FocusPaneRight` /
  `FocusPaneUp` / `FocusPaneDown` keybinding actions
